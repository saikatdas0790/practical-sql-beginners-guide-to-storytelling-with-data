...
from '/tmp/us_counties_2010.txt' with (format csv, header);
...
from '/tmp/supervisor_salaries.csv' with (format csv, header);
...
copy us_counties_2010 to '/tmp/us_counties_export.txt' with (format csv, header, delimiter '|');

copy us_counties_2010 (geo_name, internal_point_lat, internal_point_lon) to '/tmp/us_counties_latlon_export.txt' with (format csv, header, delimiter '|');
...
) to '/tmp/us_counties_mill_export.txt' with (format csv, header, delimiter '|');